...
namespace challenges.Controllers
{
   ...
   public class SumIntervalsController : ControllerBase
   {
      ...
      {
         //ERROR: testing with [-1000000000, 1000000000], very slow
         ...
         for (int i = 0; i < args.Series.Length; i++)
         {
            ...
            range.AddRange(Enumerable.Range(firstValue, secondValue - firstValue)
            .Where(number => range.IndexOf(number) == -1).ToArray());
         }
